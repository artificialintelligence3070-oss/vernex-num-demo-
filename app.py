...
def index():
    ...
    .tool.s, .edit-tool.s {
        ...
        box-shadow: inset 0 0 8px rgba(0, 255, 170, 0.05);
    }
    ...
    .login-container {
        ...
        background-color: var(--bg-color);
        background-image: 
            linear-gradient(rgba(18, 22, 28, 0.3) 1px, transparent 1px),
            linear-gradient(90deg, rgba(18, 22, 28, 0.3) 1px, transparent 1px);
    ...
    <div class="h">
        ...
        <p>SECURE HIGH-SPEED ENGINE PORT: 5990</p>
    </div>
    ...
    <div class="card">
        ...
        <button class="sel-all" onclick="toggleAll()">⚡ TOGGLE ALL PAYLOADS</button>
    </div>
